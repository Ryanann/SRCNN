...
# calculate Peak signal-to-noise ratio (open-cv also provides the function)
def psnr(target, ref):
    # assume RGB image
    ...
    diff = diff.flatten('C')  # flatten the array in row-major(C-style) order
